            ...
            <div className="table-wrap tickets-table-wrap">
              {ticketsLoading ? <Spinner /> : (
                <table className="user-tickets-table">
                  <thead>
                    <tr>
                      <th>Ticket ID</th><th>Created By</th><th>Department</th><th>Title</th><th>Assigned To</th>
                  ...
                  <tbody>
                    ...
                    {!ticketsLoading && ticketsList.length === 0 && (
                      <tr><td colSpan={8} className="muted" style={{ textAlign: 'center', padding: 32 }}>No tickets found.</td></tr>
                    )}
                  </tbody>
                </table>
              )}
